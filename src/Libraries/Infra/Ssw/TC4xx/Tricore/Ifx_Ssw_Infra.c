...
void IfxSsw_clearSram(Ifx_VMT* vmt, unsigned int ssh)
{
	...
	vmt->MC[ssh].MCONTROL.U = (1 << IFX_VMT_MC_MCONTROL_SRAM_CLR_OFF) | (1 << IFX_VMT_MC_MCONTROL_START_OFF); /* START = SRAM_CLR = 1 */
	vmt->MC[ssh].MCONTROL.U &= ~(1 << IFX_VMT_MC_MCONTROL_START_OFF); /* Clear MCONTROL START */
	...
	/* 1 read access */
	vmt->MC[ssh].CONFIG0.U  = (1 << IFX_VMT_MC_CONFIG0_NUMACCS_OFF) | (1 << IFX_VMT_MC_CONFIG0_ACCSTYPE_OFF); 
	...
	/* Start operation */
	vmt->MC[ssh].MCONTROL.U = (1 << IFX_VMT_MC_MCONTROL_DIR_OFF) | (1 << IFX_VMT_MC_MCONTROL_START_OFF);
	vmt->MC[ssh].MCONTROL.U &= ~(1 << IFX_VMT_MC_MCONTROL_START_OFF); /* Clear MCONTROL START */
