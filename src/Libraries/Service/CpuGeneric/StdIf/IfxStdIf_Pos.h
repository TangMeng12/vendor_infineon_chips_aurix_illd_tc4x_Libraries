...
#ifndef IFXSTDIF_POS_H
#define IFXSTDIF_POS_H 1
...
typedef union
{
    ...
    struct
    {
        ...
        uint32 commErrorThresholdReached : 1;           /**< \brief Communication error threshold reached */
...
/** \brief Return the reversed flag
 *
 * \param stdIf Pointer to the interface driver object
 * \return Return the reversed flag: TRUE for reversed, FALSE for not reversed
 */
typedef boolean (*IfxStdIf_Pos_GetReversed)(IfxStdIf_InterfaceDriver stdIf);
...
/** \brief Return true if the sensor absolute position is known
 *
 * \param stdIf Pointer to the interface driver object
 * For example: Encoder received the index signal.
 * \return Return true if the sensor absolute position is known
 */

typedef boolean (*IfxStdIf_Pos_IsSynchronized)(IfxStdIf_InterfaceDriver stdIf);
...
/** \brief Set the sensor reverse flag
 * \param stdIf Pointer to the interface driver object
 * \param reversed Refersed flag: TRUE for reversed, FALSE for not reversed
 * \return None
 */
typedef void (*IfxStdIf_Pos_SetReversed)(IfxStdIf_InterfaceDriver stdIf, boolean reversed);
...
struct IfxStdIf_Pos_
{
    ...
    IfxStdIf_Pos_GetReversed          getReversed;          /**< \brief \see IfxStdIf_Pos_GetReversed           */
    ...
    IfxStdIf_Pos_IsSynchronized       isSynchronized;        /**< \brief \see IfxStdIf_Pos_IsSynchronized           */
    ...
    IfxStdIf_Pos_SetReversed          setReversed;          /**< \brief \see IfxStdIf_Pos_SetReversed           */
...
/** \copydoc IfxStdIf_Pos_GetReversed
 * \param stdIf Standard interface pointer
 */
IFX_INLINE boolean IfxStdIf_Pos_getReversed(IfxStdIf_Pos *stdIf)
{
    return stdIf->getReversed(stdIf->driver);
}
...
/** \copydoc IfxStdIf_Pos_IsSynchronized
 * \param stdIf Standard interface pointer
 */
IFX_INLINE boolean IfxStdIf_Pos_isSynchronized(IfxStdIf_Pos *stdIf)
{
    return stdIf->isSynchronized(stdIf->driver);
}
...
/** \copydoc IfxStdIf_Pos_SetReversed
 * \param stdIf Standard interface pointer
 */
IFX_INLINE void IfxStdIf_Pos_setReversed(IfxStdIf_Pos *stdIf, boolean reversed)
{
    stdIf->setReversed(stdIf->driver, reversed);
}
 ...
 * \return none
 */
IFX_EXTERN void IfxStdIf_Pos_printStatus(IfxStdIf_Pos_Status status, IfxStdIf_DPipe *io);
