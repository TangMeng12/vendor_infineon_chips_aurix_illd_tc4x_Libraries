/**
 * \file IfxPpu_IntrinsicsTasking.h
 *
 ...
 *
 */
#ifndef IFXPPU_INTRINSICSTASKING_H
#define IFXPPU_INTRINSICSTASKING_H 1
/******************************************************************************/
#include "Ifx_Types.h"
/******************************************************************************/
/* *INDENT-OFF* */
...
IFX_INLINE uint32 IfxCpu_calculateCrc32(uint32 *startaddress, uint8 length)
{
    ...
    for (;length > 0; length--)
    {
        ...
        __asm("MOV d1,%0" : : "d" (*startaddress) : "d1");
...
#define Ifx__minX(X,Y)                   __minu(X,Y)
#define Ifx__maxX(X,Y)                   __maxu(X,Y)
...
/* *INDENT-ON* */
/******************************************************************************/
#endif /* IFXPPU_INTRINSICSTASKING_H */
