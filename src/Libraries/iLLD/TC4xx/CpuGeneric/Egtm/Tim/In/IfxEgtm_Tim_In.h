...
typedef enum
{
    IfxEgtm_Tim_In_SrcForTimIn_currentChannel  = 0, /**< \brief Use the input from the current channel */
    IfxEgtm_Tim_In_SrcForTimIn_previousChannel = 1  /**< \brief Use the input from the previous channel */
} IfxEgtm_Tim_In_SrcForTimIn;
...
typedef struct
{
    ...
    IfxEgtm_Tim_In_SrcForTimIn   srcForTimIn;            /**< \brief CICTRL selection to decide current or previous channel */
