...
#ifndef IFXDMA_CFG_TC4DX_H
#define IFXDMA_CFG_TC4DX_H 1
 ...
 */
#define IFXDMA_ERROR_CDTRL   (IFX_DMA_RP_CLRE_CCDTRLER_MSK << IFX_DMA_RP_CLRE_CCDTRLER_OFF)

/** \brief Error mask for daisy chain TRLError
 */
...
/** \brief Error mask for RP error status overflow
 */
#define IFXDMA_ERROR_COVFLER (IFX_DMA_RP_CLRE_COVFLER_MSK << IFX_DMA_RP_CLRE_COVFLER_OFF)
