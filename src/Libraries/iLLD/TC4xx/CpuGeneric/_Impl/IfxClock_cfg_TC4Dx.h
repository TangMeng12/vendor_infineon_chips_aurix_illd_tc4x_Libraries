...
#ifndef IFXCLOCK_CFG_TC4DX_H
#define IFXCLOCK_CFG_TC4DX_H 1
...
/** \brief Availability of External Clock GTM
 */
#define IFXCLOCK_IS_EXTCLK_GTM_AVAILABLE             (FALSE)

/** \brief Availability of External Clock GETH
 */
#define IFXCLOCK_IS_EXTCLK_GETH_AVAILABLE            (TRUE)

/** \brief Availability of External Clock XSPISL
 */
#define IFXCLOCK_IS_EXTCLK_XSPISL_AVAILABLE          (TRUE)

/** \brief Availability of K3 Divider
 */
#define IFXCLOCK_IS_K3DIVIDER_AVAILABLE              (TRUE)

/** \brief Availability of clock audio
 */
#define IFXCLOCK_IS_EXTCLK_AUDIO_AVAILABLE           (FALSE)

/** \brief Availability of External Clock FSI2
 */
#define IFXCLOCK_IS_EXTCLK_FSI2_AVAILABLE            (FALSE)

/** \brief Availability of External Clock CPB
 */
#define IFXCLOCK_IS_EXTCLK_CPB_AVAILABLE   			 (TRUE)

/** \brief Availability of External Clock MSC
 */
#define IFXCLOCK_IS_EXTCLK_MSC_AVAILABLE             (TRUE)

/** \brief Availability of External Clock HSCT
 */
#define IFXCLOCK_IS_EXTCLK_HSCT_AVAILABLE            (TRUE)

/** \brief Availability of External Clock SDMMC
 */
#define IFXCLOCK_IS_EXTCLK_SDMMC_AVAILABLE           (TRUE)

/** \brief Availability of External Clock EGTM
 */
#define IFXCLOCK_IS_EXTCLK_EGTM_AVAILABLE            (TRUE)

/** \brief Availability of External Clock MCANH
 */
#define IFXCLOCK_IS_EXTCLK_MCANH_AVAILABLE           (TRUE)

/** \brief Availability of External Clock RCB
 */
#define IFXCLOCK_IS_EXTCLK_RCB_AVAILABLE             (FALSE)

/** \brief Availability ofExternal Clock MT0
 */
#define IFXCLOCK_IS_EXTCLK_MT0_AVAILABLE             (TRUE)

/** \brief Availability of External Clock Eray
 */
#define IFXCLOCK_IS_EXTCLK_ERAY_AVAILABLE            (TRUE)

/** \brief Availability of External Clock Xspi
 */
#define IFXCLOCK_IS_EXTCLK_XSPI_AVAILABLE            (TRUE)

/** \brief System PLL KxPREDIV and KxDIV value
 */
#define IFXCLOCK_SYSPLL_KXDIV_KXPREDIV_VALUE         (0x0000A111)

/** \brief Per PLL 2 frequency pre divider
 */
#define IFXCLOCK_PERPLL_FREQ2_PREDIV                 {10u, 11u, 12u, 10u, 14u, 10u, 16u, 17u, 10u, 10u, 20u, 10u, 10u, 10u, 10u, 10u}

/** \brief Ramp oscillator Upper frequency Limit in steps of 10Mhz
 */
#define IFXCLOCK_RAMP_OSC_UPPER_FREQ_LIMIT           (400)
