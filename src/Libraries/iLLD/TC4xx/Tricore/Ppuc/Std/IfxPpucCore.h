...
/** \brief Starts the PPU core and waits until it transitions to the RUN state.
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucCore_startCore(Ifx_PPU *ppuc);

/** \brief Halts the PPU core by setting the request halt bit and waits until the core is in halt state.
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucCore_haltCore(Ifx_PPU *ppuc);

/** \brief Retrieves the current status of the PPU core.
 * \param ppuc PPUC module pointer
 * \return IfxPpucCore_Status The current status of the PPU core
 */
IFX_INLINE IfxPpucCore_Status IfxPpucCore_getCoreStatus(Ifx_PPU *ppuc);

/** \brief Configures the interrupt vector base address for the PPU core.
 * \param ppuc PPUC module pointer
...
/** \brief Enables the LBU interface for the specified PPU core.
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucCore_enableLBUInterface(Ifx_PPU *ppuc);

/** \brief Disable the LBU interface of the specified PPU core.
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucCore_disableLBUInterface(Ifx_PPU *ppuc);

/** \brief Enable the CSMDMI interface for the PPU core.
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucCore_enableCSMDMIInterface(Ifx_PPU *ppuc);

/** \brief Disable the CSMDMI interface for the specified PPU core.
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucCore_disableCSMDMIInterface(Ifx_PPU *ppuc);

/** \brief Enable the STUDMI interface on the PPU core.
 * \param ppuc PPUC module pointer
 * \return None
 */
IFX_INLINE void IfxPpucCore_enableSTUDMIInterface(Ifx_PPU *ppuc);

/** \brief Disable the STUDMI interface for the specified PPU core.
 * \param ppuc PPUC module pointer
 * \return None
 */
...
/** \brief Sets the Ptag STU configuration for a PPU core.
 * \param ppuc PPUC module pointer
 * \param ptag ptag pointer
 * \return None
 */
...
/** \brief API to trigger a SW reset and clear the status.
 * \param ppuc PPU module pointer
 * \return Returns TRUE if the software reset was successful, FALSE if the software reset was failure.
 */
