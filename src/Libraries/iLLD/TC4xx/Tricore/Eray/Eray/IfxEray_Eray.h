 ...
 * \return None
 *
 * For usage example see : \ref IfxLld_Eray_Eray_Usage
 *
 */
...
/** \brief Initializes the default module configuration buffer.
 * \param config pointer to module configuration structure.
 ...
 * \return TRUE if command accepted. FALSE if command is not accepted
 */
 ...
 * \param eray pointer to module handle.
 * \param transmitControl pointer to configure the transmit control parameter.
 * \return None
 *
 * For usage example see : \ref IfxLld_Eray_Eray_Usage
 *
