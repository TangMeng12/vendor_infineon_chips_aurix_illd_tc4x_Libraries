...
typedef enum
{
    IfxXspi_InterruptMask_Mask   = 0, /**< \brief Interrupt Mask Enable */
    IfxXspi_InterruptMask_UnMask = 1  /**< \brief Interrupt Maks Disable */
...
typedef enum
{
    IfxXspi_InterruptStatus_Active   = 1, /**< \brief 1: Interrupt Status Active */
    IfxXspi_InterruptStatus_InActive = 0  /**< \brief 0: Interrupt Status Not Active */
...
#if IFXXSPI_IS_PORT_11_AVAILABLE
	IfxXspi_SelectPort_11 = 2   /**< \brief 2: XSPI PORT 11 (GPIO) selection */
#endif /* #if IFXXSPI_IS_PORT_11_AVAILABLE */
} IfxXspi_SelectPort;
...
/** \brief Retrieves the pointer to the FIFO source register for the specified XSPI module.
 * \param xspi Pointer to the XSPI instance.
 * \return volatile Ifx_SRC_SRCR* Pointer to the FIFO source register of the XSPI module.
 */
...
/** \brief Retrieves a pointer to the error source register for the XSPI module.
 * \param xspi A pointer to the XSPI module instance.
 * \return A volatile pointer to the error source register of the XSPI module.
 */
...
/** \brief Retrieves the baudrate and related frequency configurations for the given XSPI instance.
 * \param xspi Pointer to the XSPI instance configuration.
 * \param configStatus Pointer to the structure where the baudrate and frequency information will be stored.
 * \return None
 */
