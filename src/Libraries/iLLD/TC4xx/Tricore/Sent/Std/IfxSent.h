...
/** \brief Disables a specific channel in the SENT module.
 * \param sent base address of the SENT register space
 * \param channelId SENT channel number
 * \return None
 */
...
/** \brief Initializes a SENT input pin with the specified input mode and pad driver configuration.
...
/** \brief Gets the specified channel interrupt status
 * \param sent base address of the SENT register space
 * \param channelId SENT channel number
 ...
 * \param sent base address of the SENT register space
 * \param channelId SENT channel number
 * \return The frame length in microseconds. A return value of 0 indicates an error
 */
 ...
 * \param sent base address of the SENT register space
 * \return Status (True/False) whether the clock for sent is enabled or disabled
 */
...
/** \brief Clears the interrupt status for the specified channel and source.
 * \param sent base address of the SENT register space
 * \param channelId SENT channel number
 * \param source enable the interrupt source of any interrupt of SENT Channel
 * \return None
