...
typedef enum
{
    IfxSmmSysMode_Resource_Cpu_0  = 0, /**< \brief Cpu 0 */
#if (IFXCPU_NUM_SAFE_MODULES > 1)		
    IfxSmmSysMode_Resource_Cpu_1  = 1, /**< \brief Cpu 1 */
#endif /* #if (IFXCPU_NUM_SAFE_MODULES > 1) */	
#if (IFXCPU_NUM_SAFE_MODULES > 2)	
    IfxSmmSysMode_Resource_Cpu_2  = 2, /**< \brief Cpu 2 */
#endif /* #if (IFXCPU_NUM_SAFE_MODULES > 2) */
#if (IFXCPU_NUM_SAFE_MODULES > 3)
    IfxSmmSysMode_Resource_Cpu_3  = 3, /**< \brief Cpu 3 */
#endif /* #if (IFXCPU_NUM_SAFE_MODULES > 3) */	
#if (IFXCPU_NUM_SAFE_MODULES > 4)	
    IfxSmmSysMode_Resource_Cpu_4  = 4, /**< \brief Cpu 4 */
#endif /* #if (IFXCPU_NUM_SAFE_MODULES > 4) */	
#if (IFXCPU_NUM_SAFE_MODULES > 5)	
    IfxSmmSysMode_Resource_Cpu_5  = 5, /**< \brief Cpu 5 */
#endif /* #if (IFXCPU_NUM_SAFE_MODULES > 5) */	
    IfxSmmSysMode_Resource_Cpu_cs = 6  /**< \brief CSRM CPU */
...
/** \brief Checks if a specified CPU core is in an idle state.
 * \param cpuIndex Index to identify different CPU cores
 ...
 * \param cpuIndex The index of the CPU module for which sleep mode is requested.
 * \return None
 */
