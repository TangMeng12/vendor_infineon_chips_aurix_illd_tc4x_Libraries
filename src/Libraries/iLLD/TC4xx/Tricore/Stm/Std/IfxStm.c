...
#else
    Ifx_CPU_STM_ISCR *iscr = (Ifx_CPU_STM_ISCR *)(&cpu->STM.ISCR);
...
#else
    Ifx_CPU_STM_ICR *icr = (Ifx_CPU_STM_ICR *)(&cpu->STM.STM_ICR);	
#endif /* #if (IFXSTM_IS_STMHV_AVAILABLE) */
#endif /* #if (IFX_CFG_STM_MORPHING_ENABLE) */
...
#else
    Ifx_CPU_STM_CMCON *comcon = (Ifx_CPU_STM_CMCON *)(&cpu->STM.CMCON);
    Ifx_CPU_STM_ICR   *icr    = (Ifx_CPU_STM_ICR *)(&cpu->STM.STM_ICR);
...
#else
    Ifx_CPU_STM_ISR *isr = (Ifx_CPU_STM_ISR *)(&cpu->STM.ISR);
#endif /* #if (IFXSTM_IS_STMHV_AVAILABLE) */
#endif /* #if (IFX_CFG_STM_MORPHING_ENABLE) */
