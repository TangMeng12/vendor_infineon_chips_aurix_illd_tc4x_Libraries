...
/** \brief Retrieves the CRC status information for the specified PSI5 channel.
 * \param psi5 pointer to the PSI5 register space
 * \param channel The PSI5 channel ID to retrieve the CRC status for.
 ...
 * \param psi5 pointer to the PSI5 register space
 * \param channel The PSI5 channel ID to get the
 ...
 * \param psi5 pointer to the PSI5 register space
 * \param channel The PSI5 channel ID to query the NBI status
 ...
 * \param psi5 pointer to the PSI5 register space
 * \param channel Channel Identification Number to query the NFI status.
 ...
 * \param psi5 pointer to the PSI5 register space
 * \param channel The PSI5 channel ID to query the RDI status
 ...
 * \param psi5 pointer to the PSI5 register space
 * \param channel The PSI5 channel ID to retrieve the status
 ...
 * \param psi5 pointer to the PSI5 register space
 * \param channel The channel identifier to query the RSI status
 ...
 * \param psi5 pointer to the PSI5 register space
 * \param channel The channel ID for which the TEI status
 * \return Tei status register contents
 */
IFX_INLINE uint32 IfxPsi5_getStatusTei(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel);

/** \brief Configures the PSI5 module to enter a specified sleep mode.
 * \param psi5 Pointer to the PSI5 SFR handle. This parameter must not be NULL.
 * \param mode The sleep mode to be set for the PSI5 module. This parameter is of type IfxPsi5_SleepMode.
 * \return None
 */
 ...
 * \param psi5 Pointer to PSI5 SFR handle.
 * \return None
 */
IFX_EXTERN void IfxPsi5_resetModule(Ifx_PSI5 *psi5);

/** \brief Initializes the PSI5 AP configuration structure to default values.
 * \param config Pointer to the IfxPsi5_ApConfig structure to be initialized.
 * \return None
 */
IFX_EXTERN void IfxPsi5_initApConfig(IfxPsi5_ApConfig *config);

/** \brief Initializes the PSI5 AP based on provided configuration.
 * \param psi5 Pointer to PSI5 SFR handle.
 * \param config Pointer to the IfxPsi5_ApConfig structure.
 * \return None
 */
...
/** \brief Initializes the PSI5 RX pin configuration.
 * \param rx Pointer to the PSI5 RX input configuration structure.
 * \param inputMode The input mode to be configured for the RX pin. This parameter is of type IfxPort_InputMode.
 * \param padDriver The pad driver configuration to be applied to the RX pin. This parameter is of type IfxPort_PadDriver.
 * \return None
 */
IFX_INLINE void IfxPsi5_initRxPin(const IfxPsi5_Rx_In *rx, IfxPort_InputMode inputMode, IfxPort_PadDriver padDriver);

/** \brief Initializes the TX pin for PSI5 communication.
 * \param tx Pointer to the TX configuration structure of type IfxPsi5_Tx_Out.
 * \param outputMode Output mode configuration for the TX pin of type IfxPort_OutputMode.
 * \param padDriver Pad driver strength configuration for the TX pin of type IfxPort_PadDriver.
 * \return None
 */
IFX_INLINE void IfxPsi5_initTxPin(const IfxPsi5_Tx_Out *tx, IfxPort_OutputMode outputMode, IfxPort_PadDriver padDriver);

/** \brief Sets the RX input for the PSI5 channel.
 * \param psi5Ch Pointer to the PSI5 channel handle to configure.
 * \param alternateInput The alternate input source to be selected for the RX path.
 * \return None
 */
...
/** \brief Sets the interrupt node pointer for the specified PSI5 channel.
 * \param psi5 Pointer to the Ifx_PSI5 handle.
 * \param channel The PSI5 channel to configure (IfxPsi5_ChannelId).
 * \param nodePointer Pointer to the interrupt node to be set.
 * \param triggerOutputLine The trigger output line to be used (IfxPsi5_TriggerOutput).
 * \return None
 */
...
/** \brief Enables or disables a specific interrupt source for a given channel in the PSI5 module.
 * \param psi5 Pointer to the Ifx_PSI5 module instance to configure.
 * \param channel The channel for which the interrupt is to be enabled or disabled.
 * \param interruptSource The specific interrupt source within the channel.
 * \param enabled Enable or disable the interrupt request. Use Ifx_InterruptRequest_enable to enable and Ifx_InterruptRequest_disable to disable.
 * \return None
 */
 ...
 * \param psi5 Pointer to the Ifx_PSI5 instance. This pointer must not be NULL.
 * \return Suspend status (TRUE / FALSE)
 * \retval
 *       - TRUE If the PSI5 module is suspended.
 *       - FALSE If PSI5 module is not suspended.
 */
IFX_INLINE boolean IfxPsi5_isModuleSuspended(Ifx_PSI5 *psi5);

/** \brief Configures the suspend mode for the PSI5 module. The api works only when the OCDS is enabled and in Supervisor Mode. When OCDS is disabled the OCS suspend control is ineffective.
 * \param psi5 Pointer to the Ifx_PSI5 instance to configure. This parameter must not be NULL.
 * \param mode Input parameter of type IfxPsi5_SuspendMode specifying the suspend mode to set.
 * \return None
 */
...
/** \brief Retrieves the lower 32 bits of the receive data register for a specified PSI5 channel.
 * \param psi5 Pointer to the PSI5 handle.
 * \param channel The PSI5 channel ID to access the receive data register for.
 * \return Received data.
 */
IFX_INLINE uint32 IfxPsi5_getReceiveDataRegisterLow(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel);

/** \brief Clears all interrupts for the specified channel and interrupt status register.
 * \param psi5 Pointer to the PSI5 SFR handle.
 * \param channel The channel ID for which the interrupts should be cleared.
 * \param intStatusReg The interrupt status register to be cleared.
 * \param value The register to be selected depending on the interrupt source to be probed(slot specific sources are in INTSTATB) .
 * \return None
 */
...
/** \brief Retrieves the interrupt status for a specific channel and interrupt status register.
 * \param psi5 Pointer to the PSI5 SFR handle.
 * \param channel The channel ID for which the interrupt status is to be retrieved.
 * \param intStatusReg The interrupt status register to query.
 * \return A bitmask representing the interrupt status. Each bit in the mask corresponds to an interrupt source.
 */
...
/** \brief Sets the receiver control register for a specific PSI5 channel
 * \param psi5 Pointer to PSI5 SFR's base address
 * \param channel Channel Id of PSI5 channel whose receiver operation has to be configured
...
/** \brief Enables or disables the external trigger for the specified PSI5 channel.
 * \param psi5 Pointer to the PSI5 SFR handle.
 * \param channel The channel ID to configure (e.g., IfxPsi5_ChannelId_0, IfxPsi5_ChannelId_1).
...
/** \brief Enables or disables the external trigger bypass for the specified PSI5 channel.
 * \param psi5 Pointer to the PSI5 SFR handle.
 * \param channel The channel ID of the PSI5 module to configure.
 * \param enable Boolean flag to enable (TRUE) or disable (FALSE) the external trigger bypass. [in]
 * \return None
 */
IFX_INLINE void IfxPsi5_enableExternalTriggerBypass(Ifx_PSI5 *psi5, IfxPsi5_ChannelId channel, boolean enable);

/** \brief Selects the external timebase for the specified PSI5 channel.
 * \param psi5 Pointer to the Ifx_PSI5 SFR handle.
 * \param channel The PSI5 channel for which the external timebase is to be selected.
 *                      (Type: IfxPsi5_ChannelId)
 * \param triggerline The external trigger line to be used as the timebase.
 *                        (Type: IfxPsi5_ExternalTrigger)
 * \return None
 */
...
/** \brief Clears the external timestamp source selection for the specified PSI5 module.
 * \param psi5 pointer to PSI5 registers
 * \param triggerline External Trigger Line  of type IfxPsi5_ExternalTrigger
 * \return None
 */
 ...
 * \param psi5 pointer to PSI5 registers
 * \param triggersource The trigger source to be selected for timestamp A, of type IfxPsi5_TriggerSelect (GTM/eGTM)
 * \return None
 */
 ...
 * \param psi5 pointer to PSI5 registers
 * \param triggersource The trigger source to be selected for timestamp B, of type IfxPsi5_TriggerSelect (GTM/eGTM)
 * \return None
 */
 ...
 * \param psi5 pointer to PSI5 registers
 * \param triggersource The trigger source to be selected for timestamp C, of type IfxPsi5_TriggerSelect (GTM/eGTM)
 * \return None
 */
...
/** \brief Enables a specific channel of the PSI5 peripheral.
 * \param psi5 Pointer to the PSI5 SFR handle.
 * \param channelId ID of the channel to be enabled.
 * \return None
 */
