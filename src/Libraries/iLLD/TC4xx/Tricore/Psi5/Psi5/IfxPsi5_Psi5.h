 ...
 * \param psi5 Pointer to the PSI5 module handle
 * \return None
 */
...
/** \brief Initializes the PSI5 module according to the provided configuration.
 * \param psi5 Pointer to the PSI5 module instance to be initialized.
 * \param config Pointer to the configuration structure containing the
 *                      initialization parameters for the PSI5 module.
...
/** \brief Initializes the PSI5 module configuration.
 * \param config Pointer to the configuration structure containing the initialization parameters for the PSI5 module.
...
/** \brief Reads a serial message from a specified PSI5 channel slot.
 * \param channel Pointer to the PSI5 channel structure. Cannot be NULL.
 * \param slot The slot number in the channel to read the message from.
 * \param message Pointer to the serial message structure where the read message will be stored. Cannot be NULL.
 * \return Status if the message is read or not.
 *           - TRUE The serial message was successfully read.
 *           - FALSE The serial message was not read.
 */
 ...
 * \param psi5 Pointer to the base of PSI5 registers
 * \param clock Pointer to the clock configuration settings. Specifies the required clock frequency in Hz.
