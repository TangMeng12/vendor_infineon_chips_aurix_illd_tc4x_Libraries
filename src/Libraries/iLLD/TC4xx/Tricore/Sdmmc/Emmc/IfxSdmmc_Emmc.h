 ...
 * \param cardConfig Pointer to the configuration structure containing initialization parameters.
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param hostConfig Pointer to the host configuration settings.
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param config Pointer to the configuration structure containing the settings
 *        for the eMMC module.
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param pins Pointer to the pin configuration structure containing the pin settings.
 * \return None
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param busWidth Desired bus width for data transfer.
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param address The memory address in the eMMC to read from.
 ...
 * \param emmc Handle for eMMC interface.
 * \param command The SDMMC command to be executed.
 * \param address The logical block address on the SDMMC card.
 * \param blockSize The size of each block in bytes.
 * \param descrAddress The starting address of the ADMA2 descriptor in system memory.
 * \param direction The direction of the data transfer (to or from the SDMMC card).
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param integratedDescrAddress Pointer to the integrated descriptor address used for the ADMA3 transfer.
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param command The SDMMC command to be executed.
 * \param address The memory address for the data transfer.
 * \param blockSize The size of the data block to be transferred.
 * \param data Pointer to the data buffer for the transfer.
 * \param direction The direction of the data transfer (read/write).
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param address Destination address on the eMMC device where the data will be written.
 * \param data Pointer to the data to be written to the eMMC device.
 * \return Status
 */
 ...
 * \param emmc Handle for eMMC interface.
 * \param address Starting address in the eMMC to read data from.
 * \param data Pointer to the buffer where the read data will be stored.
 ...
 * \param emmc Handle for eMMC interface.
 * \param address The starting address in the eMMC where the data will be written.
 * \param data A pointer to the data buffer containing the data to be written.
 * \param numBlocks The number of blocks to be written.
 ...
 * \param emmc Handle for eMMC interface.
 * \param rca The new Relative Card Address to be set.
 * \return Status
 */
