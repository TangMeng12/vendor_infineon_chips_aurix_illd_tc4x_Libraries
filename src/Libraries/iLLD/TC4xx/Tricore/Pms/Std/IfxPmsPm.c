...
#if IFXPMS_IS_PMS_VMONP_VDDLMU0CON_UVMOD_AVAILABLE
            pms->VMONS.VDDLMU0CON.B.UVMOD    = 0;
#endif /* #if IFXPMS_IS_PMS_VMONP_VDDLMU0CON_UVMOD_AVAILABLE */
...
#if IFXPMS_IS_PMS_VMONP_VDDLMU1CON_UVMOD_AVAILABLE
            pms->VMONS.VDDLMU1CON.B.UVMOD    = 0;
#endif /* #if IFXPMS_IS_PMS_VMONP_VDDLMU1CON_UVMOD_AVAILABLE */
