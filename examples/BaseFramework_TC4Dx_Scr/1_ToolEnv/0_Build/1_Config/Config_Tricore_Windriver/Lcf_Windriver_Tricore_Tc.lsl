...
MEMORY
{
    dsram5: org = 0x20000000 + 100, len = 240K - 100  /* Workaround for segment overlap problem*/
    psram5: org = 0x20100000, len = 64K

    dsram4: org = 0x30000000 + 100, len = 240K - 100  /* Workaround for segment overlap problem*/
    psram4: org = 0x30100000, len = 64K

    dsram3: org = 0x40000000 + 100, len = 240K - 100  /* Workaround for segment overlap problem*/
    ...
    pfls5: org = 0x81200000, len = 2M
    pfls5_nc: org = 0xa1200000, len = 2M
    ...
    lmuram: org = 0x90400000, len = 5M
    lmuram_nc: org = 0xb0400000, len = 5M
}
