...
SECTIONS
{
    ...
    .GLOBAL_sdata           ALIGN(4) : { PROVIDE(__A0_MEM = .); "*(.sdata)" "*(.sdata.*)" "*(.data_a0)" "*(.data_a0.*)" } > .
    .GLOBAL_sbss                     : { "*(.sbss)" "*(.sbss.*)" "*(.bss_a0)" "*(.bss_a0.*)" } > .
    ...
    //.GLOBAL_a1rodata         ALIGN(4) : { PROVIDE(__A1_MEM = .); "Ifx_Ssw_Tc?.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" "Cpu?_Main.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" } > pfls5
    //.GLOBAL_a1rodata         ALIGN(4) : { PROVIDE(__A1_MEM = .); "Ifx_Ssw_Tc?.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" "Cpu?_Main.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" } > pfls4
    //.GLOBAL_a1rodata         ALIGN(4) : { PROVIDE(__A1_MEM = .); "Ifx_Ssw_Tc?.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" "Cpu?_Main.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" } > pfls3
    //.GLOBAL_a1rodata         ALIGN(4) : { PROVIDE(__A1_MEM = .); "Ifx_Ssw_Tc?.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" "Cpu?_Main.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" } > pfls2
    //.GLOBAL_a1rodata         ALIGN(4) : { PROVIDE(__A1_MEM = .); "Ifx_Ssw_Tc?.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" "Cpu?_Main.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" } > pfls1
    .GLOBAL_a1rodata         ALIGN(4) : { PROVIDE(__A1_MEM = .); "Ifx_Ssw_Tc?.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" "Cpu?_Main.*(.rodata_a1)" "*(.rodata_a1.*)" "*(.ldata)" "*(.ldata.*)" } > pfls0
    PROVIDE(_LITERAL_DATA_ = __A1_MEM);

    .GLOBAL_a8rodata        ALIGN(4) : { PROVIDE(__A8_MEM = .); "*(.rodata_a8)" "*(.rodata_a8.*)"} > .
    ...
    .inttab_tc0_000 BIND (__INTTAB_CPU0 + 0x0000) ALIGN(8) : { *(.intvec_tc0_0    ) *(.intvec_tc0_0x   0) *(.intvec_tc0_ 0x0) } > pfls0
    ...
    .bmhd_0_orig (0xae404800) : { KEEP (*(.bmhd_0_orig)) } > ucb
    .bmhd_1_orig (0xae405000) : { KEEP (*(.bmhd_1_orig)) } > ucb
    .bmhd_2_orig (0xae405800) : { KEEP (*(.bmhd_2_orig)) } > ucb
    .bmhd_3_orig (0xae406000) : { KEEP (*(.bmhd_3_orig)) } > ucb
    .usercfg_0_orig (0xae408800) : { KEEP (*(.usercfg_0_orig)) } > ucb
    .usercfg_0_copy (0xae409000) : { KEEP (*(.usercfg_0_copy)) } > ucb
    ...
    .GLOBAL_a9data           ALIGN(4) : { PROVIDE(__A9_MEM = .); "*(.data_a9)" "*(.data_a9.*)" } > lmuram
