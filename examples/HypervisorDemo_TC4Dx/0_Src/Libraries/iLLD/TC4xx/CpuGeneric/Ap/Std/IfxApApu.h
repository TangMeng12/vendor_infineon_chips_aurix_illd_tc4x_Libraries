...
/** \brief API to configure access to all masters to all RMEMS.
 * \param memConfig Pointer to the memory configuration structure that contains the settings.
 * \return None
 */
IFX_EXTERN void IfxApApu_configureAccessToRmems(IfxApApu_ApuMemoryConfig *memConfig);
