 ...
 */
IFX_EXTERN IFX_CONST IfxHsphy_TpcsParams      IfxHsphy_Hsphy_defaultSgbtConfig[IFXHSPHY_NUM_OF_PHY];

/** \brief Default configuration
 */
IFX_EXTERN IFX_CONST IfxHsphy_XpcsParams      IfxHsphy_Hsphy_defaultSgmiiConfig[IFXHSPHY_NUM_OF_PHY];
...
/** \brief Default configuration
 */
IFX_EXTERN IFX_CONST IfxHsphy_XpcsParams      IfxHsphy_Hsphy_defaultConfig[IFXHSPHY_NUM_OF_PHY];
