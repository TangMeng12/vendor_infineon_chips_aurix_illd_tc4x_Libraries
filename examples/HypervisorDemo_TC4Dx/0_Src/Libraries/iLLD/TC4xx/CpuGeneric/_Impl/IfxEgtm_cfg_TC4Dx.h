...
#ifndef IFXEGTM_CFG_TC4DX_H
#define IFXEGTM_CFG_TC4DX_H 1
...
/** \brief Availability of high resolution support for PWM
 */
#define IFXEGTM_PWM_IS_HIGH_RES_AVAILABLE                  (FALSE)

/** \brief Availability of input Geth signal
 */
#define IFXEGTM_INPUT_GETH_SIGNAL_IS_AVAILABLE             (TRUE)

/** \brief Availability of input Gpt12 signal
 */
#define IFXEGTM_INPUT_GPT12_SIGNAL_IS_AVAILABLE            (FALSE)

/** \brief Software reset of PWM channels
 */
#define IFXEGTM_PWM_SW_RESET                               (TRUE)

/** \brief Availability of the PWM channel outputs for the requested PWM
 */
#define IFXEGTM_PWM_START_STOP_CHANNEL_OUTPUT_ENABLE       (TRUE)

/** \brief Availability of the PWM output status
 */
#define IFXEGTM_PWM_OUTPUT_STATUS                          (TRUE)

/** \brief If the CANXL Time input is MTI_INT or MTI_TRIG0
 */
#define IFXEGTM_CFG_CANXL_TIMEINPUT_MTI_TRIG               (FALSE)
