/**
 * \file IfxEray_PinMap_TC4Dx_BGA436_COM.c
 * \brief ERAY  details
 *
...
#include "IfxEray_PinMap_TC4Dx_BGA436_COM.h"
...
IfxEray_Txd_Out  IfxEray0_TXDA_P10_0_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)0, {&MODULE_P10, 0}, IfxPort_OutputIdx_alt12};

IfxEray_Txd_Out  IfxEray0_TXDA_P10_10_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)0, {&MODULE_P10, 10}, IfxPort_OutputIdx_alt6};
...
IfxEray_Txen_Out IfxEray0_TXENA_P10_9_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)0, {&MODULE_P10, 9}, IfxPort_OutputIdx_alt6};
...
IfxEray_Txen_Out IfxEray0_TXENB_P10_9_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P10, 9}, IfxPort_OutputIdx_alt5};
...
IfxEray_Txd_Out  IfxEray1_TXDA_P10_10_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P10, 10}, IfxPort_OutputIdx_alt7};
...
IfxEray_Txd_Out  IfxEray1_TXDB_P10_0_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P10, 0}, IfxPort_OutputIdx_alt13};
...
IfxEray_Txen_Out IfxEray1_TXENA_P10_9_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)0, {&MODULE_P10, 9}, IfxPort_OutputIdx_alt7};
...
IfxEray_Txen_Out IfxEray1_TXENB_P04_2_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P04, 2}, IfxPort_OutputIdx_alt6};

IfxEray_Txen_Out IfxEray1_TXENB_P10_6_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P10, 6}, IfxPort_OutputIdx_alt7};

IfxEray_Txen_Out IfxEray1_TXENB_P10_9_OUT = {&MODULE_ERAY1, (IfxEray_NodeId)1, {&MODULE_P10, 9}, IfxPort_OutputIdx_alt8};
    ...
    {
        {
            ...
            &IfxEray0_TXDA_P10_0_OUT,
            &IfxEray0_TXDA_P10_10_OUT,
...
IFX_CONST IfxEray_Txen_Out *IfxEray_Txen_Out_pinTable[IFXERAY_PINMAP_NUM_MODULES][IFXERAY_PINMAP_NUM_NODES][IFXERAY_PINMAP_TXEN_OUT_NUM_ITEMS] = {
    ...
    },
    {
        ...
        },
        {
            ...
            &IfxEray1_TXENB_P04_2_OUT,
            &IfxEray1_TXENB_P10_6_OUT,
            &IfxEray1_TXENB_P10_9_OUT,
