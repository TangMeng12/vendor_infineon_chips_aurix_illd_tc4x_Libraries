...
/** \brief Retrieves the next free channel that can be configured
 * \param ppuc PPUC module pointer
 * \return Returns the next free channel number
 */
...
/** \brief Returns the channel status of specified channel.
 * \param ppuc PPUC module pointer
...
/** \brief Clears the channel event status of a specified channel.
 * \param ppuc PPUC module pointer
 * \param channelNum The virtual channel number
 * \return None
 */
 ...
 * \param ppuc PPUC Module pointer
 * \param maxChannels The maximum number of channels to be set
 * \return None
 */
IFX_INLINE void IfxPpucStu_setMaxChannels(Ifx_PPU *ppuc, uint8 maxChannels);

/** \brief Checks if the specified PPU channel interrupt is done.
 * \param ppuc PPUC module pointer
 * \param channelNum The virtual channel number
 * \return Returns TRUE if Done interrupt flag is set, FALSE if the flag is not set
 */
...
/** \brief Initializes the channel configuration with default values.
 * \param channelConfig Pointer to the channel configuration structure that will be initialized.
 * \return None
 */
