...
/** \brief Clock source. Impacts baudrate calculation.
 * Definition in Ifx_MSC_FDR.ACS
 */
typedef enum
{
    IfxMsc_Clock_fSPB = 0,  /**< \brief Default configuration. SPB clock frequency is used as source for MSC output */
    IfxMsc_Clock_fSRI = 1   /**< \brief SRI clock frequency is used as source for MSC output */
} IfxMsc_Clock;
