/**
 * \file Cpu1_Main_Vm4.c
 * \brief Main function definition for Cpu core 1 , VM4.
 *
...
#if (IFX_CFG_TC1_VM4_INT != 0U)
IFX_INTERRUPT_VM(Cpu1_Vm4_Isr, IFX_CFG_INT_TC1, IFX_CFG_INT_VM4, IFX_VM4_ISR_PRIORITY)
{
    uint32 stmTicks;
