/**
 * \file Cpu0_Main_Vm3.c
 * \brief Main function definition for Cpu core 0 , VM3.
 *
...
#if (IFX_CFG_TC0_VM3_INT != 0U)
IFX_INTERRUPT_VM(Cpu0_Vm3_Isr, IFX_CFG_INT_TC0, IFX_CFG_INT_VM3, IFX_VM3_ISR_PRIORITY)
{
    uint32 stmTicks;
