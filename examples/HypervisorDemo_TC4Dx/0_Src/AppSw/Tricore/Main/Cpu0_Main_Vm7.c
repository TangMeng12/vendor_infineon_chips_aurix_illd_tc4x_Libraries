/**
 * \file Cpu0_Main_Vm7.c
 * \brief Main function definition for Cpu core 0 , VM7.
 *
...
#if (IFX_CFG_TC0_VM7_INT != 0U)
IFX_INTERRUPT_VM(Cpu0_Vm7_Isr, IFX_CFG_INT_TC0, IFX_CFG_INT_VM7, IFX_VM7_ISR_PRIORITY)
{
    uint32 stmTicks;
