/**
 * \file Cpu3_Main_Vm1.c
 * \brief Main function definition for Cpu core 3 , VM1.
 *
...
#if (IFX_CFG_TC3_VM1_INT != 0U)
IFX_INTERRUPT_VM(Cpu3_Vm1_Isr, IFX_CFG_INT_TC3, IFX_CFG_INT_VM1, IFX_VM1_ISR_PRIORITY)
{
    uint32 stmTicks;
