/**
 * \file Cpu3_Main_Vm7.c
 * \brief Main function definition for Cpu core 3 , VM7.
 *
...
volatile unsigned int tc3_vm7_scheduler_ctr = 0u;
volatile unsigned int tc3_vm7_main_ctr      = 0u;
volatile unsigned int tc3_vm7_isr_ctr       = 0u;
IFX_INTERRUPT_FUNC void Cpu3_Vm7_Isr(void);
...
void core3_vm7_main(void)
{
#if (IFX_CFG_TC3_VM7_INT != 0U)
    ...
    {
        tc3_vm7_main_ctr++;
        tc3_vm7_scheduler_ctr++;
#if (IFX_DEBUG_PRINT == 1U)

#if (IFX_CFG_TC3_VM7_INT != 0U)
        printf("TC3 VM7 isr Counter is %d\n", tc3_vm7_isr_ctr);
#else
        printf("TC3 VM7 main Counter is %d\n", tc3_vm7_main_ctr);
#endif
#endif

#if (IFX_CFG_HV3_TIME_BASED_SCHD == 0U)

        if (tc3_vm7_scheduler_ctr > 50u)
        {
            tc3_vm7_scheduler_ctr = 0u;
            Ifx__hvcall(7);
        }
...
#if (IFX_CFG_TC3_VM7_INT != 0U)
IFX_INTERRUPT_VM(Cpu3_Vm7_Isr, IFX_CFG_INT_TC3, IFX_CFG_INT_VM7, IFX_VM7_ISR_PRIORITY)
{
    uint32 stmTicks;
