/**
 * \file Cpu0_Main_Vm6.c
 * \brief Main function definition for Cpu core 0 , VM6.
 *
...
#if (IFX_CFG_TC0_VM6_INT != 0U)
IFX_INTERRUPT_VM(Cpu0_Vm6_Isr, IFX_CFG_INT_TC0, IFX_CFG_INT_VM6, IFX_VM6_ISR_PRIORITY)
{
    uint32 stmTicks;
