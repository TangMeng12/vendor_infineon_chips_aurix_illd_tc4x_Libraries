/**
 * \file Cpu0_Main_Vm1.c
 * \brief Main function definition for Cpu core 0 , VM1.
 *
...
#if (IFX_CFG_TC0_VM1_INT != 0U)
IFX_INTERRUPT_VM(Cpu0_Vm1_Isr, IFX_CFG_INT_TC0, IFX_CFG_INT_VM1, IFX_VM1_ISR_PRIORITY)
{
    uint32 stmTicks;
