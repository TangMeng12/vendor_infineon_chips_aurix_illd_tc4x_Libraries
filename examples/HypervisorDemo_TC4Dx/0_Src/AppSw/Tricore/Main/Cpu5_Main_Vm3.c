/**
 * \file Cpu5_Main_Vm3.c
 * \brief Main function definition for Cpu core 5 , VM3.
 *
...
#if (IFX_CFG_TC5_VM3_INT != 0U)
IFX_INTERRUPT_VM(Cpu5_Vm3_Isr, IFX_CFG_INT_TC5, IFX_CFG_INT_VM3, IFX_VM3_ISR_PRIORITY)
{
    uint32 stmTicks;
