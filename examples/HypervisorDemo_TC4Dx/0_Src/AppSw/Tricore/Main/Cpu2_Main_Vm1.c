/**
 * \file Cpu2_Main_Vm1.c
 * \brief Main function definition for Cpu core 2 , VM1.
 *
...
volatile unsigned int tc2_vm1_scheduler_ctr = 0u;
volatile unsigned int tc2_vm1_main_ctr      = 0u;
volatile unsigned int tc2_vm1_isr_ctr       = 0u;
IFX_INTERRUPT_FUNC void Cpu2_Vm1_Isr(void);
...
void core2_vm1_main(void)
{
#if (IFX_CFG_TC2_VM1_INT != 0U)
    ...
    {
        tc2_vm1_main_ctr++;
        tc2_vm1_scheduler_ctr++;
#if (IFX_DEBUG_PRINT == 1U)

#if (IFX_CFG_TC2_VM1_INT != 0U)
        printf("TC2 VM1 isr Counter is %d\n", tc2_vm1_isr_ctr);
#else
        printf("TC2 VM1 main Counter is %d\n", tc2_vm1_main_ctr);
#endif
#endif

#if (IFX_CFG_HV2_TIME_BASED_SCHD == 0U)

        if (tc2_vm1_scheduler_ctr > 50u)
        {
            tc2_vm1_scheduler_ctr = 0u;
            Ifx__hvcall(1);
        }
...
#if (IFX_CFG_TC2_VM1_INT != 0U)
IFX_INTERRUPT_VM(Cpu2_Vm1_Isr, IFX_CFG_INT_TC2, IFX_CFG_INT_VM1, IFX_VM1_ISR_PRIORITY)
{
    uint32 stmTicks;
