/**
 * \file Cpu3_Main_Vm5.c
 * \brief Main function definition for Cpu core 3 , VM5.
 *
...
#if (IFX_CFG_TC3_VM5_INT != 0U)
IFX_INTERRUPT_VM(Cpu3_Vm5_Isr, IFX_CFG_INT_TC3, IFX_CFG_INT_VM5, IFX_VM5_ISR_PRIORITY)
{
    uint32 stmTicks;
