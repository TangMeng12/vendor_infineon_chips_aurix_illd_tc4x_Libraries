/**
 * \file Cpu5_Main_Vm6.c
 * \brief Main function definition for Cpu core 5 , VM6.
 *
...
volatile unsigned int tc5_vm6_scheduler_ctr = 0u;
volatile unsigned int tc5_vm6_main_ctr      = 0u;
volatile unsigned int tc5_vm6_isr_ctr       = 0u;
IFX_INTERRUPT_FUNC void Cpu5_Vm6_Isr(void);
...
void core5_vm6_main(void)
{
#if (IFX_CFG_TC5_VM6_INT != 0U)
    ...
    {
        tc5_vm6_main_ctr++;
        tc5_vm6_scheduler_ctr++;
#if (IFX_DEBUG_PRINT == 1U)

#if (IFX_CFG_TC5_VM6_INT != 0U)
        printf("TC5 VM6 isr Counter is %d\n", tc5_vm6_isr_ctr);
#else
        printf("TC5 VM6 main Counter is %d\n", tc5_vm6_main_ctr);
#endif
#endif

#if (IFX_CFG_HV5_TIME_BASED_SCHD == 0U)

        if (tc5_vm6_scheduler_ctr > 50u)
        {
            tc5_vm6_scheduler_ctr = 0u;
            Ifx__hvcall(6);
        }
...
#if (IFX_CFG_TC5_VM6_INT != 0U)
IFX_INTERRUPT_VM(Cpu5_Vm6_Isr, IFX_CFG_INT_TC5, IFX_CFG_INT_VM6, IFX_VM6_ISR_PRIORITY)
{
    uint32 stmTicks;
