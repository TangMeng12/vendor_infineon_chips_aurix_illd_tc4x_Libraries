/**
 * \file Cpu5_Main_Vm4.c
 * \brief Main function definition for Cpu core 5 , VM4.
 *
...
#if (IFX_CFG_TC5_VM4_INT != 0U)
IFX_INTERRUPT_VM(Cpu5_Vm4_Isr, IFX_CFG_INT_TC5, IFX_CFG_INT_VM4, IFX_VM4_ISR_PRIORITY)
{
    uint32 stmTicks;
