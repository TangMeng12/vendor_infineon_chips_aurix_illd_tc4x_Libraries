/**
 * \file IfxHv_Cpu4VmSched.c
 * \brief Hypervisor Scheduler Software for Core4
 *
...
Hr2Context Tc4_Vm2_Context;
Hr2Context Tc4_Vm3_Context;
Hr2Context Tc4_Vm4_Context;
Hr2Context Tc4_Vm5_Context;
Hr2Context Tc4_Vm6_Context;
Hr2Context Tc4_Vm7_Context;
 ...
 */
IFXHV_INLINE void Core4_vm1_start(void);
IFXHV_INLINE void Core4_vm2_start(void);
IFXHV_INLINE void Core4_vm3_start(void);
IFXHV_INLINE void Core4_vm4_start(void);
IFXHV_INLINE void Core4_vm5_start(void);
IFXHV_INLINE void Core4_vm6_start(void);
IFXHV_INLINE void Core4_vm7_start(void);
...
void core4_vm0_start(void)
{
    ...
    Tc4_Vm1.State = VM_INIT;
    Tc4_Vm2.State = VM_INIT;
    Tc4_Vm3.State = VM_INIT;
    Tc4_Vm4.State = VM_INIT;
    Tc4_Vm5.State = VM_INIT;
    Tc4_Vm6.State = VM_INIT;
    Tc4_Vm7.State = VM_INIT;
...
#if (IFX_CFG_HV4_TIME_BASED_SCHD != 0U)
    ...
    g_stmTicks[0]                 = IFX_CORE4_VM1_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[1]                 = IFX_CORE4_VM2_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[2]                 = IFX_CORE4_VM3_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[3]                 = IFX_CORE4_VM4_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[4]                 = IFX_CORE4_VM5_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[5]                 = IFX_CORE4_VM6_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[6]                 = IFX_CORE4_VM7_EXECUTION_TIME * IfxHv_getStmFrequency();

    cmcon.U                       = CPU4_STMHV_VM0_CMCON.U;
    icr.U                         = CPU4_STMHV_VM0_STM_ICR.U;

    cmcon.B.MSIZE0                = IfxHv4_StmConfig.compareSize;
    cmcon.B.MSTART0               = IfxHv4_StmConfig.compareOffset;
    cmcon.B.RELCOMP0              = IfxHv4_StmConfig.comparison;
    CPU4_STMHV_VM0_CMCON.U        = cmcon.U;

    srcTmp.U                      = SRC_STMCPU4_SR0.U;

    srcTmp.B.SRPN                 = IfxHv4_StmConfig.triggerPriority;
    srcTmp.B.TOS                  = IfxHv4_StmConfig.typeOfService;
    srcTmp.B.VM                   = IfxHv4_StmConfig.vmId;
    srcTmp.B.SRE                  = 1U;

    SRC_STMCPU4_SR0.U             = srcTmp.U;
    CPU4_STMHV_VM0_ISCR.B.CMP0IRR = 1U;

    icr.B.CMP0EN                  = 1U;
    icr.B.CMP0OS                  = IfxHv4_StmConfig.comparatorInterrupt;

    CPU4_STMHV_VM0_STM_ICR.U      = icr.U;
    CPU4_STMHV_VM0_CMP0.U         = (uint32)((CPU4_STM_ABS.U >> IfxHv4_StmConfig.compareOffset) + g_stmTicks[0]);
    ...
    MODULE_INT.ICU[4].VMEN.U = (IFX_CFG_TC4_VM1_INT << IFX_INT_ICU_VMEN_VM1_OFF) | (IFX_CFG_TC4_VM2_INT << IFX_INT_ICU_VMEN_VM2_OFF) | \
                               (IFX_CFG_TC4_VM3_INT << IFX_INT_ICU_VMEN_VM3_OFF) | (IFX_CFG_TC4_VM4_INT << IFX_INT_ICU_VMEN_VM4_OFF) | \
                               (IFX_CFG_TC4_VM5_INT << IFX_INT_ICU_VMEN_VM5_OFF) | (IFX_CFG_TC4_VM6_INT << IFX_INT_ICU_VMEN_VM6_OFF) | \
                               (IFX_CFG_TC4_VM7_INT << IFX_INT_ICU_VMEN_VM7_OFF) | 1u;

    /* Threshold configuration */
    IFXHV_MTCR(CPU_VM1_PETHRESH, IfxHv4_VmThresholdConfig.vm1ThresholdVal);
    IFXHV_MTCR(CPU_VM2_PETHRESH, IfxHv4_VmThresholdConfig.vm2ThresholdVal);
    IFXHV_MTCR(CPU_VM3_PETHRESH, IfxHv4_VmThresholdConfig.vm3ThresholdVal);
    IFXHV_MTCR(CPU_VM4_PETHRESH, IfxHv4_VmThresholdConfig.vm4ThresholdVal);
    IFXHV_MTCR(CPU_VM5_PETHRESH, IfxHv4_VmThresholdConfig.vm5ThresholdVal);
    IFXHV_MTCR(CPU_VM6_PETHRESH, IfxHv4_VmThresholdConfig.vm6ThresholdVal);
    IFXHV_MTCR(CPU_VM7_PETHRESH, IfxHv4_VmThresholdConfig.vm7ThresholdVal);
...
IFXHV_INLINE void Core4_vm1_start(void)
{
    ...
    Tc4_Hv.CurrRunningVm = HV_VM1;
    Tc4_Vm1.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM1 | (PRS1 << 8u)));
    IFXHV_SETA11((void *)__START41);
    ...
    Hv_setCsaAddress((__CSA40), HV_VM1);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core4_vm2_start(void)
{
    ...
    Tc4_Hv.CurrRunningVm = HV_VM2;
    Tc4_Vm2.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM2 | (PRS2 << 8u)));
    IFXHV_SETA11((void *)__START42);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA40), HV_VM2);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core4_vm3_start(void)
{
    ...
    Tc4_Hv.CurrRunningVm = HV_VM3;
    Tc4_Vm3.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM3 | (PRS3 << 8u)));
    IFXHV_SETA11((void *)__START43);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA40), HV_VM3);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core4_vm4_start(void)
{
    ...
    Tc4_Hv.CurrRunningVm = HV_VM4;
    Tc4_Vm4.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM4 | (PRS4 << 8u)));
    IFXHV_SETA11((void *)__START44);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA40), HV_VM4);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core4_vm5_start(void)
{
    ...
    Tc4_Hv.CurrRunningVm = HV_VM5;
    Tc4_Vm5.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM5 | (PRS5 << 8u)));
    IFXHV_SETA11((void *)__START45);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA40), HV_VM5);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core4_vm6_start(void)
{
    ...
    Tc4_Hv.CurrRunningVm = HV_VM6;
    Tc4_Vm6.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM6 | (PRS6 << 8u)));
    IFXHV_SETA11((void *)__START46);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA40), HV_VM6);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core4_vm7_start(void)
{
    ...
    Tc4_Hv.CurrRunningVm = HV_VM7;
    Tc4_Vm7.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM7 | (PRS7 << 8u)));
    IFXHV_SETA11((void *)__START47);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA40), HV_VM7);
    IFXHV_RFH();
}
...
void Hv4_Vm_PreEmptionScheduler(void)
{
    ...
    if (Tc4_Hv.CurrRunningVm == HV_VM1)
    {
        Ifx_Hv_saveVmState(&Tc4_Vm1);
    }
    else if (Tc4_Hv.CurrRunningVm == HV_VM2)
    {
        Ifx_Hv_saveVmState(&Tc4_Vm2);
        /* STORE the VM2 context in memory before starting VM3, Since VM3 shares the same HR as VM2 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc4_Vm2_Context);
    }
    else if (Tc4_Hv.CurrRunningVm == HV_VM3)
    {
        Ifx_Hv_saveVmState(&Tc4_Vm3);
        /* STORE the VM3 context in memory before starting VM4, Since VM4 shares the same HR as VM3 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc4_Vm3_Context);
    }
    else if (Tc4_Hv.CurrRunningVm == HV_VM4)
    {
        Ifx_Hv_saveVmState(&Tc4_Vm4);
        /* STORE the VM4 context in memory before starting VM5, Since VM5 shares the same HR as VM4 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc4_Vm4_Context);
    }
    else if (Tc4_Hv.CurrRunningVm == HV_VM5)
    {
        Ifx_Hv_saveVmState(&Tc4_Vm5);
        /* STORE the VM5 context in memory before starting VM6, Since VM6 shares the same HR as VM5 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc4_Vm5_Context);
    }
    else if (Tc4_Hv.CurrRunningVm == HV_VM6)
    {
        Ifx_Hv_saveVmState(&Tc4_Vm6);
        /* STORE the VM6 context in memory before starting VM7, Since VM7 shares the same HR as VM6 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc4_Vm6_Context);
    }
    else if (Tc4_Hv.CurrRunningVm == HV_VM7)
    {
        Ifx_Hv_saveVmState(&Tc4_Vm7);
        Ifx_Ssw_Hv_saveHr2Context(&Tc4_Vm7_Context);
    }

    switch (vmNum)
    {
    case 1:
        Ifx_Hv_restoreVmState(&Tc4_Hv, &Tc4_Vm1, VM1);
        break;
    case 2:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc4_Vm2_Context);
        Ifx_Hv_restoreVmState(&Tc4_Hv, &Tc4_Vm2, VM2);
        break;
    case 3:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc4_Vm3_Context);
        Ifx_Hv_restoreVmState(&Tc4_Hv, &Tc4_Vm3, VM3);
        break;
    case 4:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc4_Vm4_Context);
        Ifx_Hv_restoreVmState(&Tc4_Hv, &Tc4_Vm4, VM4);
        break;
    case 5:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc4_Vm5_Context);
        Ifx_Hv_restoreVmState(&Tc4_Hv, &Tc4_Vm5, VM5);
        break;
    case 6:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc4_Vm6_Context);
        Ifx_Hv_restoreVmState(&Tc4_Hv, &Tc4_Vm6, VM6);
        break;
    case 7:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc4_Vm7_Context);
        Ifx_Hv_restoreVmState(&Tc4_Hv, &Tc4_Vm7, VM7);
        break;
    default:
        break;
    }
...
void Hv4_Vm_Scheduler(void)
{
    ...
    else if (Tc4_Hv.CurrRunningVm == HV_VM2)
    {
         ...
         * is already complete.
         */
        if (Tc4_Vm3.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc4_Vm3_Context);
            /* Start VM3 */
            Core4_vm3_start();
        }
        else
    ...
    else if (Tc4_Hv.CurrRunningVm == HV_VM3)
    {
         ...
         * is already complete.
         */
        if (Tc4_Vm4.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc4_Vm4_Context);
            /* Start VM4 */
            Core4_vm4_start();
        }
        else
    ...
    else if (Tc4_Hv.CurrRunningVm == HV_VM4)
    {
         ...
         * is already complete.
         */
        if (Tc4_Vm5.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc4_Vm5_Context);
            /* Start VM5 */
            Core4_vm5_start();
        }
        else
    ...
    else if (Tc4_Hv.CurrRunningVm == HV_VM5)
    {
         ...
         * is already complete.
         */
        if (Tc4_Vm6.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc4_Vm6_Context);
            /* Start VM6 */
            Core4_vm6_start();
        }
        else
    ...
    else if (Tc4_Hv.CurrRunningVm == HV_VM6)
    {
         ...
         * is already complete.
         */
        if (Tc4_Vm7.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc4_Vm7_Context);
            /* Start VM6 */
            Core4_vm7_start();
        }
        else
...
IFX_INTERRUPT_VM_RFH(Hv4_Vm_Scheduler, IFX_CFG_INT_TC4, IFX_CFG_INT_VM0, IFX_VM0_SCHD_PRIORITY)
{
    ...
    if (Tc4_Hv.CurrRunningVm == HV_VM1)
    {
        ...
        CPU4_STMHV_VM0_CMP0.U = CPU4_STMHV_VM0_CMP0.U + g_stmTicks[1];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU4_STMHV_VM0_CMP0.U = CPU4_STMHV_VM0_CMP0.U + g_stmTicks[2];
    ...
    else if (Tc4_Hv.CurrRunningVm == HV_VM3)
    {
        ...
        CPU4_STMHV_VM0_CMP0.U = CPU4_STMHV_VM0_CMP0.U + g_stmTicks[3];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU4_STMHV_VM0_CMP0.U = CPU4_STMHV_VM0_CMP0.U + g_stmTicks[4];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU4_STMHV_VM0_CMP0.U = CPU4_STMHV_VM0_CMP0.U + g_stmTicks[5];
        /* Save context information of VM5 */
        Ifx_Hv_saveVmState(&Tc4_Vm5);
    ...
    {
        /* Load next VM exeuction ticks */
        CPU4_STMHV_VM0_CMP0.U = CPU4_STMHV_VM0_CMP0.U + g_stmTicks[6];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU4_STMHV_VM0_CMP0.U = CPU4_STMHV_VM0_CMP0.U + g_stmTicks[0];
