/**
 * \file IfxHv_Cpu3VmSched.c
 * \brief Hypervisor Scheduler Software for Core3
 *
...
Hr2Context Tc3_Vm2_Context;
Hr2Context Tc3_Vm3_Context;
Hr2Context Tc3_Vm4_Context;
Hr2Context Tc3_Vm5_Context;
Hr2Context Tc3_Vm6_Context;
Hr2Context Tc3_Vm7_Context;
 ...
 */
IFXHV_INLINE void Core3_vm1_start(void);
IFXHV_INLINE void Core3_vm2_start(void);
IFXHV_INLINE void Core3_vm3_start(void);
IFXHV_INLINE void Core3_vm4_start(void);
IFXHV_INLINE void Core3_vm5_start(void);
IFXHV_INLINE void Core3_vm6_start(void);
IFXHV_INLINE void Core3_vm7_start(void);
...
void core3_vm0_start(void)
{
    ...
    Tc3_Vm1.State = VM_INIT;
    Tc3_Vm2.State = VM_INIT;
    Tc3_Vm3.State = VM_INIT;
    Tc3_Vm4.State = VM_INIT;
    Tc3_Vm5.State = VM_INIT;
    Tc3_Vm6.State = VM_INIT;
    Tc3_Vm7.State = VM_INIT;
    ...
    g_stmTicks[0]                 = IFX_CORE3_VM1_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[1]                 = IFX_CORE3_VM2_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[2]                 = IFX_CORE3_VM3_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[3]                 = IFX_CORE3_VM4_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[4]                 = IFX_CORE3_VM5_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[5]                 = IFX_CORE3_VM6_EXECUTION_TIME * IfxHv_getStmFrequency();
    g_stmTicks[6]                 = IFX_CORE3_VM7_EXECUTION_TIME * IfxHv_getStmFrequency();

    cmcon.U                       = CPU3_STMHV_VM0_CMCON.U;
    icr.U                         = CPU3_STMHV_VM0_STM_ICR.U;

    cmcon.B.MSIZE0                = IfxHv3_StmConfig.compareSize;
    cmcon.B.MSTART0               = IfxHv3_StmConfig.compareOffset;
    cmcon.B.RELCOMP0              = IfxHv3_StmConfig.comparison;
    CPU3_STMHV_VM0_CMCON.U        = cmcon.U;

    srcTmp.U                      = SRC_STMCPU3_SR0.U;

    srcTmp.B.SRPN                 = IfxHv3_StmConfig.triggerPriority;
    srcTmp.B.TOS                  = IfxHv3_StmConfig.typeOfService;
    srcTmp.B.VM                   = IfxHv3_StmConfig.vmId;
    srcTmp.B.SRE                  = 1U;

    SRC_STMCPU3_SR0.U             = srcTmp.U;
    CPU3_STMHV_VM0_ISCR.B.CMP0IRR = 1U;

    icr.B.CMP0EN                  = 1U;
    icr.B.CMP0OS                  = IfxHv3_StmConfig.comparatorInterrupt;

    CPU3_STMHV_VM0_STM_ICR.U      = icr.U;
    CPU3_STMHV_VM0_CMP0.U         = (uint32)((CPU3_STM_ABS.U >> IfxHv3_StmConfig.compareOffset) + g_stmTicks[0]);
    ...
    MODULE_INT.ICU[3].VMEN.U = (IFX_CFG_TC3_VM1_INT << IFX_INT_ICU_VMEN_VM1_OFF) | (IFX_CFG_TC3_VM2_INT << IFX_INT_ICU_VMEN_VM2_OFF) | \
                               (IFX_CFG_TC3_VM3_INT << IFX_INT_ICU_VMEN_VM3_OFF) | (IFX_CFG_TC3_VM4_INT << IFX_INT_ICU_VMEN_VM4_OFF) | \
                               (IFX_CFG_TC3_VM5_INT << IFX_INT_ICU_VMEN_VM5_OFF) | (IFX_CFG_TC3_VM6_INT << IFX_INT_ICU_VMEN_VM6_OFF) | \
                               (IFX_CFG_TC3_VM7_INT << IFX_INT_ICU_VMEN_VM7_OFF) | 1u;

    /* Threshold configuration */
    IFXHV_MTCR(CPU_VM1_PETHRESH, IfxHv3_VmThresholdConfig.vm1ThresholdVal);
    IFXHV_MTCR(CPU_VM2_PETHRESH, IfxHv3_VmThresholdConfig.vm2ThresholdVal);
    IFXHV_MTCR(CPU_VM3_PETHRESH, IfxHv3_VmThresholdConfig.vm3ThresholdVal);
    IFXHV_MTCR(CPU_VM4_PETHRESH, IfxHv3_VmThresholdConfig.vm4ThresholdVal);
    IFXHV_MTCR(CPU_VM5_PETHRESH, IfxHv3_VmThresholdConfig.vm5ThresholdVal);
    IFXHV_MTCR(CPU_VM6_PETHRESH, IfxHv3_VmThresholdConfig.vm6ThresholdVal);
    IFXHV_MTCR(CPU_VM7_PETHRESH, IfxHv3_VmThresholdConfig.vm7ThresholdVal);
...
IFXHV_INLINE void Core3_vm1_start(void)
{
    ...
    Tc3_Hv.CurrRunningVm = HV_VM1;
    Tc3_Vm1.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM1 | (PRS1 << 8u)));
    IFXHV_SETA11((void *)__START31);
    ...
    Hv_setCsaAddress((__CSA30), HV_VM1);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core3_vm2_start(void)
{
    ...
    Tc3_Hv.CurrRunningVm = HV_VM2;
    Tc3_Vm2.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM2 | (PRS2 << 8u)));
    IFXHV_SETA11((void *)__START32);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA30), HV_VM2);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core3_vm3_start(void)
{
    ...
    Tc3_Hv.CurrRunningVm = HV_VM3;
    Tc3_Vm3.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM3 | (PRS3 << 8u)));
    IFXHV_SETA11((void *)__START33);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA30), HV_VM3);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core3_vm4_start(void)
{
    ...
    Tc3_Hv.CurrRunningVm = HV_VM4;
    Tc3_Vm4.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM4 | (PRS4 << 8u)));
    IFXHV_SETA11((void *)__START34);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA30), HV_VM4);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core3_vm5_start(void)
{
    ...
    Tc3_Hv.CurrRunningVm = HV_VM5;
    Tc3_Vm5.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM5 | (PRS5 << 8u)));
    IFXHV_SETA11((void *)__START35);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA30), HV_VM5);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core3_vm6_start(void)
{
    ...
    Tc3_Hv.CurrRunningVm = HV_VM6;
    Tc3_Vm6.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM6 | (PRS6 << 8u)));
    IFXHV_SETA11((void *)__START36);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA30), HV_VM6);
    IFXHV_RFH();
}
...
IFXHV_INLINE void Core3_vm7_start(void)
{
    ...
    Tc3_Hv.CurrRunningVm = HV_VM7;
    Tc3_Vm7.State        = VM_RUN;
    IFXHV_MTCR(CPU_VCON2, (VM7 | (PRS7 << 8u)));
    IFXHV_SETA11((void *)__START37);
     ...
     * Care shall be done, to avoid corruption of these locations when HV (VM0) is active.*/
    Hv_setCsaAddress((__CSA30), HV_VM7);
    IFXHV_RFH();
}
...
void Hv3_Vm_PreEmptionScheduler(void)
{
    ...
    if (Tc3_Hv.CurrRunningVm == HV_VM1)
    {
        Ifx_Hv_saveVmState(&Tc3_Vm1);
    }
    else if (Tc3_Hv.CurrRunningVm == HV_VM2)
    {
        Ifx_Hv_saveVmState(&Tc3_Vm2);
        /* STORE the VM2 context in memory before starting VM3, Since VM3 shares the same HR as VM2 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc3_Vm2_Context);
    }
    else if (Tc3_Hv.CurrRunningVm == HV_VM3)
    {
        Ifx_Hv_saveVmState(&Tc3_Vm3);
        /* STORE the VM3 context in memory before starting VM4, Since VM4 shares the same HR as VM3 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc3_Vm3_Context);
    }
    else if (Tc3_Hv.CurrRunningVm == HV_VM4)
    {
        Ifx_Hv_saveVmState(&Tc3_Vm4);
        /* STORE the VM4 context in memory before starting VM5, Since VM5 shares the same HR as VM4 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc3_Vm4_Context);
    }
    else if (Tc3_Hv.CurrRunningVm == HV_VM5)
    {
        Ifx_Hv_saveVmState(&Tc3_Vm5);
        /* STORE the VM5 context in memory before starting VM6, Since VM6 shares the same HR as VM5 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc3_Vm5_Context);
    }
    else if (Tc3_Hv.CurrRunningVm == HV_VM6)
    {
        Ifx_Hv_saveVmState(&Tc3_Vm6);
        /* STORE the VM6 context in memory before starting VM7, Since VM7 shares the same HR as VM6 i.e HR2 */
        Ifx_Ssw_Hv_saveHr2Context(&Tc3_Vm6_Context);
    }
    else if (Tc3_Hv.CurrRunningVm == HV_VM7)
    {
        Ifx_Hv_saveVmState(&Tc3_Vm7);
        Ifx_Ssw_Hv_saveHr2Context(&Tc3_Vm7_Context);
    }

    switch (vmNum)
    {
    case 1:
        Ifx_Hv_restoreVmState(&Tc3_Hv, &Tc3_Vm1, VM1);
        break;
    case 2:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc3_Vm2_Context);
        Ifx_Hv_restoreVmState(&Tc3_Hv, &Tc3_Vm2, VM2);
        break;
    case 3:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc3_Vm3_Context);
        Ifx_Hv_restoreVmState(&Tc3_Hv, &Tc3_Vm3, VM3);
        break;
    case 4:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc3_Vm4_Context);
        Ifx_Hv_restoreVmState(&Tc3_Hv, &Tc3_Vm4, VM4);
        break;
    case 5:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc3_Vm5_Context);
        Ifx_Hv_restoreVmState(&Tc3_Hv, &Tc3_Vm5, VM5);
        break;
    case 6:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc3_Vm6_Context);
        Ifx_Hv_restoreVmState(&Tc3_Hv, &Tc3_Vm6, VM6);
        break;
    case 7:
        Ifx_Ssw_Hv_restoreHr2Context(&Tc3_Vm7_Context);
        Ifx_Hv_restoreVmState(&Tc3_Hv, &Tc3_Vm7, VM7);
        break;
    default:
        break;
    }
...
void Hv3_Vm_Scheduler(void)
{
    ...
    else if (Tc3_Hv.CurrRunningVm == HV_VM2)
    {
         ...
         * is already complete.
         */
        if (Tc3_Vm3.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc3_Vm3_Context);
            /* Start VM3 */
            Core3_vm3_start();
        }
        else
    ...
    else if (Tc3_Hv.CurrRunningVm == HV_VM3)
    {
         ...
         * is already complete.
         */
        if (Tc3_Vm4.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc3_Vm4_Context);
            /* Start VM4 */
            Core3_vm4_start();
        }
        else
    ...
    else if (Tc3_Hv.CurrRunningVm == HV_VM4)
    {
         ...
         * is already complete.
         */
        if (Tc3_Vm5.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc3_Vm5_Context);
            /* Start VM5 */
            Core3_vm5_start();
        }
        else
    ...
    else if (Tc3_Hv.CurrRunningVm == HV_VM5)
    {
         ...
         * is already complete.
         */
        if (Tc3_Vm6.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc3_Vm6_Context);
            /* Start VM6 */
            Core3_vm6_start();
        }
        else
    ...
    else if (Tc3_Hv.CurrRunningVm == HV_VM6)
    {
         ...
         * is already complete.
         */
        if (Tc3_Vm7.State == VM_INIT)
        {
            Ifx_Ssw_Hv_resetHr2Context(&Tc3_Vm7_Context);
            /* Start VM6 */
            Core3_vm7_start();
        }
        else
...
IFX_INTERRUPT_VM_RFH(Hv3_Vm_Scheduler, IFX_CFG_INT_TC3, IFX_CFG_INT_VM0, IFX_VM0_SCHD_PRIORITY)
{
    ...
    if (Tc3_Hv.CurrRunningVm == HV_VM1)
    {
        ...
        CPU3_STMHV_VM0_CMP0.U = CPU3_STMHV_VM0_CMP0.U + g_stmTicks[1];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU3_STMHV_VM0_CMP0.U = CPU3_STMHV_VM0_CMP0.U + g_stmTicks[2];
    ...
    else if (Tc3_Hv.CurrRunningVm == HV_VM3)
    {
        ...
        CPU3_STMHV_VM0_CMP0.U = CPU3_STMHV_VM0_CMP0.U + g_stmTicks[3];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU3_STMHV_VM0_CMP0.U = CPU3_STMHV_VM0_CMP0.U + g_stmTicks[4];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU3_STMHV_VM0_CMP0.U = CPU3_STMHV_VM0_CMP0.U + g_stmTicks[5];
        /* Save context information of VM5 */
        Ifx_Hv_saveVmState(&Tc3_Vm5);
    ...
    {
        /* Load next VM exeuction ticks */
        CPU3_STMHV_VM0_CMP0.U = CPU3_STMHV_VM0_CMP0.U + g_stmTicks[6];
    ...
    {
        /* Load next VM exeuction ticks */
        CPU3_STMHV_VM0_CMP0.U = CPU3_STMHV_VM0_CMP0.U + g_stmTicks[0];
